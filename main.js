...
ctx.fillText("Happy Birthday David!", width / 2, height / 2 - 100);
...
function animation() {
  ...
  if (firstFrame < 1401) {
    ...
    ctx.font = "100px Courier";
    ctx.fillStyle = "Red";
    ctx.fillText("David", 20 + firstFrame, 100);
    ctx.fillStyle = "Orange";
    ctx.fillText("🍪🍪🍪🍪🍪🍪🍪🍪🍪", 1200 - firstFrame, 200);
    ctx.fillStyle = "Green";
    ctx.fillText("Happy Birthday!", 20 + firstFrame, 300);
    ctx.fillStyle = "Blue";
    ctx.fillText("❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️", 1200 - firstFrame, 400);
